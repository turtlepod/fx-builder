...
<script id="tmpl-fxb-item" type="text/html">
	...
	<div class="fxb-item fxb-clear" data-item_id="{{data.item_id}}" data-item_state="{{data.item_state}}" data-item_type="{{data.item_type}}" data-item_index="{{data.item_index}}">
		...
		<?php /* HIDDEN FIELD */ ?>
		<input type="hidden" data-item_field="item_id" name="fxb_items[{{data.item_id}}][item_id]" value="{{data.item_id}}" autocomplete="off"/>

		<input type="hidden" data-item_field="item_index" name="fxb_items[{{data.item_id}}][item_index]" value="{{data.item_index}}" autocomplete="off"/>

		<input type="hidden" data-item_field="item_state" name="fxb_items[{{data.item_id}}][item_state]" value="{{data.item_state}}" autocomplete="off"/>

		<input type="hidden" data-item_field="item_type" name="fxb_items[{{data.item_id}}][item_type]" value="text" autocomplete="off"/>

		<?php /* CONTEXT FIELD */ ?>
		<input type="hidden" data-item_field="row_id" name="fxb_items[{{data.item_id}}][row_id]" value="{{data.row_id}}" autocomplete="off"/>

		<input type="hidden" data-item_field="col_index" name="fxb_items[{{data.item_id}}][col_index]" value="{{data.col_index}}" autocomplete="off"/>
