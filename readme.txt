...
**[f(x) {PLUGIN NAME}](http://genbumedia.com/plugins/{PLUGIN SLUG}/)** is a plugin to ... {LONG DESCRIPTION}
...
1. Support available at [Genbu Media](https://genbumedia.com/contact/?about={SLUG}).
...
5. {ADDITIONAL INSTALLATION INSTRUCTION}
...
Development of this plugin is hosted at [GitHub](https://github.com/turtlepod/{GITHUB SLUG}). Pull request and bug reports are welcome.
